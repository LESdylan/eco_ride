...
DROP TABLE IF EXISTS submits, participate, uses, own, manages, has_param;
DROP TABLE IF EXISTS review, role, carpool, car, brand;
DROP TABLE IF EXISTS user, configuration, parameter;

-- What is the flag engine --innodb
CREATE TABLE	user
(
...
(
	parameter_id	INT	AUTOINCREMENT PRIMARY KEY,
	property		VARCHAR(50),
	value			VARCHAR(50)
)
